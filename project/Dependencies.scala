...
object Dependencies {
  ...
  object Versions {
    ...
    val PostgresDriverVersion: String      = "42.7.1"
    ...
    val OpenTelemetrySdkVersion: String                = "1.35.0"
    val TestContainers: String                         = "0.41.3"
    val OpenTelemetrySdkConfigVersion: String          = "1.35.0"
    val OpenTelemetryInstrumentationApiVersion: String = "2.0.0"
    val OpenTelemetrySdkTestingVersion: String         = "1.35.0"
    val OpenTelemetryExtensionVersion: String          = "1.35.0"
