...
object Dependencies {
  ...
  object Versions {
    ...
    val OpenTelemetrySdkVersion: String                = "1.42.1"
    val TestContainers: String                         = "0.41.4"
    val OpenTelemetrySdkConfigVersion: String          = "1.42.1"
    val OpenTelemetryInstrumentationApiVersion: String = "2.8.0"
    val OpenTelemetrySdkTestingVersion: String         = "1.42.1"
