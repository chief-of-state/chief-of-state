...
object Dependencies {
  ...
  object Versions {
    ...
    val OpenTelemetrySdkVersion: String                = "1.61.0"
    val TestContainers: String                         = "0.44.1"
    val OpenTelemetrySdkConfigVersion: String          = "1.61.0"
    val OpenTelemetryInstrumentationApiVersion: String = "2.25.0"
    val OpenTelemetrySdkTestingVersion: String         = "1.61.0"
    val OpenTelemetryExtensionVersion: String          = "1.61.0"
    val OpenTelemetryApiVersion: String                = "1.61.0"
