...
object Dependencies {
  ...
  object Versions {
    ...
    val OpenTelemetrySdkVersion: String                = "1.34.1"
    val TestContainers: String                         = "0.41.0"
    val OpenTelemetrySdkConfigVersion: String          = "1.34.1"
    val OpenTelemetryInstrumentationApiVersion: String = "2.0.0"
    val OpenTelemetrySdkTestingVersion: String         = "1.34.1"
    val OpenTelemetryExtensionVersion: String          = "1.34.1"
