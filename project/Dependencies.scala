...
object Dependencies {
  ...
  object Versions {
    ...
    val PostgresDriverVersion: String = "42.5.4"
    ...
    val OpenTelemetrySdkVersion: String = "1.23.1"
    val TestContainers: String = "0.40.14"
    val OpenTelemetrySdkConfigVersion: String = "1.15.0-alpha"
    val OpenTelemetryInstrumentationApiVersion: String = "1.23.0"
    val OpenTelemetrySdkTestingVersion: String = "1.23.1"
    val OpenTelemetryExtensionVersion: String = "1.23.1"
