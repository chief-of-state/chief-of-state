...
object Dependencies {
  ...
  object Versions {
    ...
    val OpenTelemetryInstrumentationApiVersion: String = "1.20.2"
    val OpenTelemetrySdkTestingVersion: String = "1.20.1"
    val OpenTelemetryExtensionVersion: String = "1.20.1"
