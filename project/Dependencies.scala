...
object Dependencies {
  ...
  object Versions {
    ...
    val OpenTelemetrySdkVersion: String                = "1.40.0"
    val TestContainers: String                         = "0.41.4"
    val OpenTelemetrySdkConfigVersion: String          = "1.40.0"
    val OpenTelemetryInstrumentationApiVersion: String = "2.5.0"
    val OpenTelemetrySdkTestingVersion: String         = "1.40.0"
    val OpenTelemetryExtensionVersion: String          = "1.40.0"
