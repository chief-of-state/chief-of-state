...
object Dependencies {
  ...
  object Versions {
    ...
    val OpenTelemetrySdkVersion: String                = "1.31.0"
    val TestContainers: String                         = "0.41.0"
    val OpenTelemetrySdkConfigVersion: String          = "1.31.0"
    val OpenTelemetryInstrumentationApiVersion: String = "1.32.0"
    val OpenTelemetrySdkTestingVersion: String         = "1.31.0"
    val OpenTelemetryExtensionVersion: String          = "1.31.0"
