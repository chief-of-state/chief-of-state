...
object Dependencies {
  ...
  object Versions {
    ...
    val PostgresDriverVersion: String      = "42.7.3"
    ...
    val OpenTelemetrySdkVersion: String                = "1.41.0"
    val TestContainers: String                         = "0.41.4"
    val OpenTelemetrySdkConfigVersion: String          = "1.41.0"
    val OpenTelemetryInstrumentationApiVersion: String = "2.7.0"
    val OpenTelemetrySdkTestingVersion: String         = "1.41.0"
    val OpenTelemetryExtensionVersion: String          = "1.41.0"
